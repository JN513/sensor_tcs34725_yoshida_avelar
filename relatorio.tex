...
%\begin{center}
%\includegraphics[width=0.7\textwidth]{imgs/monstagem.jpg}\\
%\textit{Figura: Montagem do sistema na BitDogLab.}
%\end{center}

%\begin{center}
%\includegraphics[width=0.7\textwidth]{imgs/saida.jpg}\\
%\textit{Figura: Saída no terminal durante o teste.}
%\end{center}
